...
`precise.yml` is Astroclaw's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Astroclaw paths are excluded by `.gitignore` for build reasons even though
