...
export type AstroclawTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableAstroclawTransport = AstroclawTransport & {
...
export type AstroclawEventType =
  | "run.created"
  | "run.queued"
  | "run.started"
  | "run.completed"
...
export type AstroclawEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
