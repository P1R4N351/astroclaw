...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "astroclaw:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Astroclaw-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/astroclaw/astroclaw/issues/63921
 */
