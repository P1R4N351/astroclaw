...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "astroclaw/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("astroclaw.feishuThreadBindingsState");
