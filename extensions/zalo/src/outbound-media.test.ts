...
vi.mock("astroclaw/plugin-sdk/outbound-media", () => ({
...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under Astroclaw control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredAstroclawTmpDir(), "astroclaw-zalo-outbound-media");
