...
import { formatInboundEnvelope } from "astroclaw/plugin-sdk/channel-envelope";
...
function makeCfg(storePath: string): AstroclawConfig {
  return {
...
function createHandlerForTest(opts: { cfg: AstroclawConfig; replyResolver: unknown }) {
