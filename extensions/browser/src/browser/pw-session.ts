...
// Astroclaw operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Astroclaw itself navigated to a blocked URL.
...
export async function createPageViaPlaywright(
  ...
  if (targetUrl !== "about:blank") {
    ...
    // Astroclaw owns this newly-created tab: if the post-navigation safety
