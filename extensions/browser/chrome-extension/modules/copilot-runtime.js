...
var B = class {
    ...
    next(e) {
      ...
      let o = Math.max(this.attempts, 1),
        i = n ?? Xe({ ...this.policy, initialMs: this.initialMs }, o);
      this.cancel();
  ...
  J = { attempts: 3, minDelayMs: 300, maxDelayMs: 3e4, jitter: 0 },
  ze = (t) =>
    new Promise((e) => {
      setTimeout(e, t);
    });
...
function $e(t, e = "Non-Error thrown") {
...
var G = class extends Error {
  ...
  te = class {
    ...
    handleMessage(e, n, o) {
      ...
      Ae(i) && (this.opts.onActivity?.(), this.handleResponse(i));
    }
    handleResponse(e) {
...
var re = (t) => (t instanceof P ? t : y("Point expected")),
  ...
  P = class t {
    ...
    isTorsionFree() {
      let e = this.multiply(Y / 2n, !1).double();
