...
const providerFilter = parseCsvFilter(process.env.ASTROCLAW_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.ASTROCLAW_LIVE_MUSIC_GENERATION_MODELS);
