...
function mergeZalouserAccountConfig(cfg: AstroclawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: AstroclawConfig; accountId?: string | null }) {
