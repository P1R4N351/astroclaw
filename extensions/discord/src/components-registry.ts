...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("astroclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("astroclaw.discord.modalEntries");
