...
// Deprecated compatibility surface for existing @astroclaw/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "astroclaw/plugin-sdk/runtime-group-policy";
