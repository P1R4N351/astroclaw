...
export function buildMissingXSearchApiKeyPayload() {
  return {
    ...
    message:
      "x_search needs an xAI API key. Run astroclaw onboard --auth-choice xai-api-key, set XAI_API_KEY in the Gateway environment, or configure plugins.entries.xai.config.webSearch.apiKey.",
