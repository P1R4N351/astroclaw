...
function readLegacyGrokFallbackAuth(cfg?: AstroclawConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: AstroclawConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: AstroclawConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: AstroclawConfig): string | undefined {
