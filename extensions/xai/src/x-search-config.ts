...
function resolveLegacyXSearchConfig(config?: AstroclawConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: AstroclawConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: AstroclawConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: AstroclawConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: AstroclawConfig): JsonRecord | undefined {
