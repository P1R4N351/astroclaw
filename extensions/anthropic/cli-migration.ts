...
type AgentDefaultsModel = NonNullable<NonNullable<AstroclawConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<AstroclawConfig["agents"]>["defaults"]>["models"];
