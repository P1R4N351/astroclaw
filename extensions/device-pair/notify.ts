...
import type { AstroclawPluginService } from "astroclaw/plugin-sdk/core";
import { listDevicePairing } from "astroclaw/plugin-sdk/device-bootstrap";
...
export function createPairingNotifierService(api: AstroclawPluginApi): AstroclawPluginService {
...
export function registerPairingNotifierService(api: AstroclawPluginApi): void {
