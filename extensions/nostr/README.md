...
Nostr DM channel plugin for Astroclaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Astroclaw. It enables your bot to:
...
# Configure astroclaw to use local relay
