...
vi.mock("astroclaw/plugin-sdk/channel-inbound", async (importOriginal) => ({
  implicitMentionKindWhen: (await import("astroclaw/plugin-sdk/channel-mention-gating"))
    .implicitMentionKindWhen,
  logInboundDrop: (await importOriginal<typeof import("astroclaw/plugin-sdk/channel-inbound")>())
    .logInboundDrop,
  buildMentionRegexes: () => [],
