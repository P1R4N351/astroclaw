...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: AstroclawConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as AstroclawConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as AstroclawConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as AstroclawConfig | null) ?? undefined,
