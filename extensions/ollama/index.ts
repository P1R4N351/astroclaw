...
import { buildApiKeyCredential } from "astroclaw/plugin-sdk/provider-auth";
import type {
...
export default definePluginEntry({
  ...
  register(api: AstroclawPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: AstroclawConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "astroclaw configure". ' +
        "See: https://docs.astroclaw.ai/providers/ollama",
    });
  },
});
