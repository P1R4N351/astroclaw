...
const installedSymbol = Symbol.for("astroclaw.lobster.ajv-compile-cache.installed");
const cacheSymbol = Symbol.for("astroclaw.lobster.ajv-compile-cache.entries");
