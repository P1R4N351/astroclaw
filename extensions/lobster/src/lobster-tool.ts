...
type BoundTaskFlow = ReturnType<
  NonNullable<AstroclawPluginApi["runtime"]>["tasks"]["managedFlows"]["bindSession"]
>;
...
export function createLobsterTool(api: AstroclawPluginApi, options?: LobsterToolOptions) {
