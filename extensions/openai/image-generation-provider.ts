...
import { resolveClosestSize } from "astroclaw/plugin-sdk/media-generation-runtime";
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.ASTROCLAW_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
...
function hasExplicitOpenAIDirectAuthConfig(cfg: AstroclawConfig | undefined): boolean {
...
function hasExplicitOpenAIDirectProviderConfig(cfg: AstroclawConfig | undefined): boolean {
