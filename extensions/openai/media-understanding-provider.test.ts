    ...
    async (apiKey) =>
      withEnvAsync({ OPENAI_API_KEY: undefined }, async () => {
        const [
          ...
          import("astroclaw/plugin-sdk/plugin-test-contracts"),
          import("astroclaw/plugin-sdk/plugin-test-runtime"),
          import("astroclaw/plugin-sdk/channel-test-helpers"),
          import("./index.js"),
        ]);
        const cfg = {
        ...
        const realAuth = await vi.importActual<
          typeof import("astroclaw/plugin-sdk/provider-auth-runtime")
        >("astroclaw/plugin-sdk/provider-auth-runtime");
