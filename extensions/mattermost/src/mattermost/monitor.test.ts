import { createClaimableDedupe } from "astroclaw/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: AstroclawConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<AstroclawConfig["channels"]>["mattermost"]>;
