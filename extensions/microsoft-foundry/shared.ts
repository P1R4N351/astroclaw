import type { AuthConfig } from "astroclaw/plugin-sdk/config-contracts";
import {
...
import type { ModelApi, ModelProviderConfig } from "astroclaw/plugin-sdk/provider-model-shared";
import {
