...
import { asFiniteNumber, asObject, trimToUndefined } from "astroclaw/plugin-sdk/speech-core";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: AstroclawConfig | undefined): string | undefined {
