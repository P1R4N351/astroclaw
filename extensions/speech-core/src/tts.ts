...
import { resolveChannelTtsVoiceDelivery } from "astroclaw/plugin-sdk/channel-targets";
import type {
  AstroclawConfig,
  ResolvedTtsPersona,
  TtsAutoMode,
...
import { isVerbose, logVerbose } from "astroclaw/plugin-sdk/runtime-env";
import { tempWorkspaceSync, resolvePreferredAstroclawTmpDir } from "astroclaw/plugin-sdk/sandbox";
import { privateFileStoreSync } from "astroclaw/plugin-sdk/security-runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
  normalizeOptionalString,
} from "astroclaw/plugin-sdk/string-coerce-runtime";
import { stripMarkdown } from "astroclaw/plugin-sdk/text-chunking";
import { resolveConfigDir, resolveUserPath } from "astroclaw/plugin-sdk/text-utility-runtime";
import {
...
function sortSpeechProvidersForAutoSelection(cfg?: AstroclawConfig) {
...
function resolveTtsRuntimeConfig(cfg: AstroclawConfig): AstroclawConfig {
  return (
    selectApplicableRuntimeConfig({
      inputConfig: cfg,
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: AstroclawConfig): TtsProvider[] {
