...
import { runCommandWithRuntime, theme } from "astroclaw/plugin-sdk/cli-runtime";
...
import { defaultRuntime } from "astroclaw/plugin-sdk/runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "astroclaw/plugin-sdk/string-coerce-runtime";
import { shortenHomePath } from "astroclaw/plugin-sdk/text-utility-runtime";
    ...
    a2ui
      ...
      .action(async (opts: CanvasNodesRpcOpts) => {
        await deps.runNodesCommand("canvas a2ui push", async () => {
          ...
          if (version === "v0.9") {
            throw new Error(
              "Detected A2UI v0.9 JSONL (createSurface). Astroclaw currently supports v0.8 only.",
            );
          }
