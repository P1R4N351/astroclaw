...
const mocks = vi.hoisted(() => ({
  ...
  imageResultFromFile: vi.fn<
    typeof import("astroclaw/plugin-sdk/channel-actions").imageResultFromFile
  >(async (params) => {
  ...
  saveMediaBuffer: vi.fn<typeof import("astroclaw/plugin-sdk/media-store").saveMediaBuffer>(
    async (buffer) => ({
      id: "snapshot.png",
