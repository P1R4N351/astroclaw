...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<AstroclawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<AstroclawConfig["channels"]>["slack"]>>,
): AstroclawConfig {
  return {
    channels: {
      slack: {
