...
import { buildApprovalInteractiveReplyFromActionDescriptors } from "astroclaw/plugin-sdk/approval-reply-runtime";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<AstroclawConfig["channels"]>["slack"]>["execApprovals"]
>;
