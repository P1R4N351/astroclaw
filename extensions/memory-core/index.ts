...
function getToolConfig(options: MemoryToolOptions): AstroclawConfig | undefined {
...
function resolveMemoryToolOptions(ctx: AstroclawPluginToolContext): MemoryToolOptions {
