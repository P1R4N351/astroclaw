...
export function registerShortTermPromotionDreaming(api: AstroclawPluginApi): void {
  ...
  const resolveCurrentConfig = (): AstroclawConfig =>
    (api.runtime.config?.current?.() ?? api.config) as AstroclawConfig;
