...
const TEST_MEMORY_WATCH_FACTORY_KEY = Symbol.for("astroclaw.test.memoryWatchFactory");
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: AstroclawConfig;
  ...
  protected async runSync(params?: {
    ...
    const targetedSessionSync = await runMemoryTargetedSessionSync({
      ...
      useUnsafeReindex:
        ...
        process.env.ASTROCLAW_TEST_MEMORY_UNSAFE_REINDEX === "1",
      sessionsDirtyFiles: this.sessionsDirtyFiles,
