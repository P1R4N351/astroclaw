...
const QMD_UPDATE_QUEUE_KEY = Symbol.for("astroclaw.qmdUpdateQueueState");
...
function normalizeHanBm25Query(query: string): string {
  ...
  // Keep Han/CJK BM25 queries intact so Astroclaw search semantics match direct qmd search.
  return trimmed;
}
