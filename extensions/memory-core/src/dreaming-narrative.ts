...
import { createAsyncLock } from "astroclaw/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "astroclaw/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "astroclaw/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "astroclaw/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
...
const DIARY_START_MARKER = "<!-- astroclaw:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- astroclaw:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "astroclaw:dreaming:backfill-entry";
