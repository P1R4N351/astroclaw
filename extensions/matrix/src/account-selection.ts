...
import { hasConfiguredSecretInput } from "astroclaw/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: AstroclawConfig): Record<string, unknown> | null {
