...
import type { TelegramExecApprovalConfig } from "astroclaw/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: AstroclawConfig): Array<string | number> {
