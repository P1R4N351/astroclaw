...
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("astroclaw/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyHarnessParams = Parameters<DispatchReplyWithBufferedBlockDispatcherFn>[0];
type ReadRemoteMediaBufferFn =
  typeof import("astroclaw/plugin-sdk/media-runtime").readRemoteMediaBuffer;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  getRuntimeConfig: (() =>
    ...
    }) as AstroclawConfig) as TelegramBotDeps["getRuntimeConfig"],
