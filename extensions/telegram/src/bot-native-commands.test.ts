...
import type { OpenClawConfig, TelegramAccountConfig } from "astroclaw/plugin-sdk/config-contracts";
import { listNativeCommandSpecsForConfig } from "astroclaw/plugin-sdk/native-command-registry";
