...
import { isTruthyEnvValue, isWSL2Sync } from "astroclaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "astroclaw/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "ASTROCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "ASTROCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "ASTROCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable ASTROCLAW_TELEGRAM_DNS_RESULT_ORDER
