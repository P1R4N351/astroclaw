...
import { createChannelPluginBase, type ChannelPlugin } from "astroclaw/plugin-sdk/channel-core";
 ...
 */
function isBlockedByMultiBotGuard(cfg: AstroclawConfig, accountId: string): boolean {
