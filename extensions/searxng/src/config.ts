...
export function resolveSearxngCategories(config?: AstroclawConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: AstroclawConfig): string | undefined {
