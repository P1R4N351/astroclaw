...
import type {
  ...
  MessageEventContent,
} from "@astroclaw/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@astroclaw/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } =
    await import("astroclaw/plugin-sdk/qa-runner-runtime");
