...
import { createWebSearchProviderContractFields } from "astroclaw/plugin-sdk/provider-web-search-config-contract";
...
export function createBraveWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.astroclaw.ai/tools/brave-search",
    autoDetectOrder: 10,
