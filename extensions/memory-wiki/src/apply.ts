...
const GENERATED_START = "<!-- astroclaw:wiki:generated:start -->";
const GENERATED_END = "<!-- astroclaw:wiki:generated:end -->";
const HUMAN_START = "<!-- astroclaw:human:start -->";
const HUMAN_END = "<!-- astroclaw:human:end -->";
