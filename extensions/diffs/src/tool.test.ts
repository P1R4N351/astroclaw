...
const { resolvePreferredAstroclawTmpDir } = vi.hoisted(() => ({
...
describe("diffs tool", () => {
  ...
  beforeEach(async () => {
    resolvePreferredAstroclawTmpDir.mockReturnValue(os.tmpdir());
    ({
      rootDir,
      store,
      blobStore,
    ...
    resolvePreferredAstroclawTmpDir.mockReturnValue(rootDir);
  });
