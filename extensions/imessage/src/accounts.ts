...
function mergeIMessageAccountConfig(cfg: AstroclawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AstroclawConfig): ResolvedIMessageAccount[] {
