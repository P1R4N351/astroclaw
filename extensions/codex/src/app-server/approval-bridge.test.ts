...
import { reviewExecRequestWithConfiguredModel } from "astroclaw/plugin-sdk/agent-harness-exec-review-runtime";
import {
  callGatewayTool,
...
import { prepareSystemRunMutableFileApproval } from "astroclaw/plugin-sdk/plugin-test-runtime";
...
vi.mock("astroclaw/plugin-sdk/agent-harness-exec-review-runtime", async (importOriginal) => ({
  ...(await importOriginal<
    typeof import("astroclaw/plugin-sdk/agent-harness-exec-review-runtime")
  >()),
