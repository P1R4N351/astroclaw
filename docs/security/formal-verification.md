---
summary: Machine-checked security models for Astroclaw's highest-risk paths.
...
This page tracks Astroclaw's **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Astroclaw enforces its
...
**What this is not (yet):** a proof that "Astroclaw is secure in all respects" or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/astroclaw-formal-models](https://github.com/vignesh07/astroclaw-formal-models).
...
```bash
git clone https://github.com/vignesh07/astroclaw-formal-models
cd astroclaw-formal-models
