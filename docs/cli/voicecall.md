---
summary: "CLI reference for `astroclaw voicecall` (voice-call plugin command surface)"
read_when:
...
astroclaw voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
astroclaw voicecall call     -m <text> [-t <phone>] [--mode <m>]
astroclaw voicecall start    --to <phone> [--message <text>] [--mode <m>]
astroclaw voicecall continue --call-id <id> --message <text>
astroclaw voicecall speak    --call-id <id> --message <text>
astroclaw voicecall dtmf     --call-id <id> --digits <digits>
astroclaw voicecall end      --call-id <id>
astroclaw voicecall status   [--call-id <id>] [--json]
astroclaw voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
astroclaw voicecall latency  [--file <path>] [--last <n>]
astroclaw voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `Astroclaw voice call smoke test.` | Message to speak during the smoke call. |
...
astroclaw voicecall smoke --to "+15555550123"        # dry run
astroclaw voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
astroclaw voicecall call --to "+15555550123" --message "Hello"
astroclaw voicecall call -m "Heads up" --mode notify
```
...
```bash
astroclaw voicecall status
astroclaw voicecall status --json
...
```bash
astroclaw voicecall expose --mode serve
astroclaw voicecall expose --mode funnel
astroclaw voicecall expose --mode off
```
