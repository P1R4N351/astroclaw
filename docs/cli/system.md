---
summary: "CLI reference for `astroclaw system` (system events, heartbeat, presence)"
read_when:
...
astroclaw system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$ASTROCLAW_GATEWAY_TOKEN"
astroclaw system heartbeat enable
astroclaw system heartbeat last
astroclaw system presence
```
