---
summary: "Run Astroclaw Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want Astroclaw running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running Astroclaw in Docker on Hetzner or a similar provider
title: "Hetzner"
---

## Goal

Run a persistent Astroclaw Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want "Astroclaw 24/7 for ~$5", this is the simplest reliable setup.
...
<Steps>
  ...
  <Step title="Create persistent host directories">
    ...
    ```bash
    mkdir -p /root/.astroclaw/workspace

    # Set ownership to the container user (uid 1000):
    chown -R 1000:1000 /root/.astroclaw
    ```
  ...
  <Step title="Configure environment variables">
    ...
    ASTROCLAW_CONFIG_DIR=/root/.astroclaw
    ASTROCLAW_WORKSPACE_DIR=/root/.astroclaw/workspace
...
- Infrastructure: [astroclaw-terraform-hetzner](https://github.com/andreesg/astroclaw-terraform-hetzner)
- Docker config: [astroclaw-docker-config](https://github.com/andreesg/astroclaw-docker-config)
