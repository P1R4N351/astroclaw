...
read_when:
  - Planning a broad Astroclaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local Astroclaw skill,
create `.agents/skills/astroclaw-frontend/SKILL.md` first, keep the frontmatter
