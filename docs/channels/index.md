---
summary: "Messaging platforms Astroclaw can connect to"
read_when:
  - You want to choose a chat channel for Astroclaw
  - You need a quick overview of supported messaging platforms
title: "Chat channels"
---

Astroclaw can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- [iMessage](/channels/imessage) - Native macOS integration via the `imsg` bridge on a signed-in Mac (or SSH wrapper when the Gateway runs elsewhere), including private API actions for replies, tapbacks, effects, attachments, and group management. Preferred for new Astroclaw iMessage setups when host permissions and Messages access fit.
...
- Channels can run simultaneously; configure multiple and Astroclaw will route per chat.
