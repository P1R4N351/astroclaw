...
Zalo ships as a bundled plugin in current Astroclaw releases, so normal packaged
...
- Install via CLI: `astroclaw plugins install @astroclaw/zalo`
- Pinned version: `astroclaw plugins install @astroclaw/zalo@2026.5.2`
- Or from a source checkout: `astroclaw plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Astroclaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `astroclaw pairing list zalo`
  - `astroclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Astroclaw.
...
- Example: `astroclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `astroclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `astroclaw logs --follow`
