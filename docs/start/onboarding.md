---
summary: "First-run setup flow for Astroclaw (macOS app)"
read_when:
...
- By default, Astroclaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Astroclaw">
...
<Step title="CLI">
  ...
  The app can install the global `astroclaw` CLI via npm, pnpm, or bun.
