---
summary: "Overview of Astroclaw onboarding options and flows"
read_when:
...
Astroclaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `astroclaw onboard`                     | Launch the app            |
...
CLI command docs: [`astroclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the Astroclaw app. The first-run wizard walks you through the same steps
