...
[Tavily](https://tavily.com) is a search API designed for AI applications. Astroclaw exposes it in two ways:
...
<Tip>
Choosing Tavily in onboarding or `astroclaw configure --section web` enables the bundled Tavily plugin automatically.
</Tip>
