...
title: "Together AI"
read_when:
  - You want to use Together AI with Astroclaw
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    astroclaw onboard --auth-choice together-api-key
    ```
  </Step>
...
Astroclaw ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.astroclaw/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `astroclaw models list --provider together`
