...
<Steps>
  ...
  <Step title="Configure Astroclaw">
    Point Astroclaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Astroclaw
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Astroclaw integration with Claude CLI or API keys.
  </Card>
