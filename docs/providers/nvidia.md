---
summary: "Use NVIDIA's OpenAI-compatible API in Astroclaw"
read_when:
  - You want to use open models in Astroclaw for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    astroclaw onboard --auth-choice nvidia-api-key
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    astroclaw models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
...
```bash
astroclaw onboard --auth-choice nvidia-api-key --nvidia-api-key "nvapi-..."
```
