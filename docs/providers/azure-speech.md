---
summary: "Azure AI Speech text-to-speech for Astroclaw replies"
read_when:
...
Azure Speech is an Azure AI Speech text-to-speech provider. In Astroclaw it
...
Astroclaw uses the Azure Speech REST API directly with SSML and sends the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Astroclaw synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; Astroclaw derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. Astroclaw
...
<CardGroup cols={2}>
  ...
  <Card title="Providers" href="/providers" icon="grid">
    All bundled Astroclaw providers.
  </Card>
