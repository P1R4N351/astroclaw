---
summary: "Use Qianfan's unified API to access many models in Astroclaw"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    astroclaw onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    astroclaw models list --provider qianfan
    ```
  </Step>
</Steps>
