---
summary: "Inworld streaming text-to-speech for Astroclaw replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In Astroclaw it
...
Astroclaw posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Astroclaw synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    Astroclaw asks Inworld for `OGG_OPUS` so the audio plays as a native
