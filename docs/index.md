---
summary: "Astroclaw is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Astroclaw to newcomers
title: "Astroclaw"
---
...
<p align="center">
    <img
        src="/assets/astroclaw-logo-text-dark.png"
        alt="Astroclaw"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/astroclaw-logo-text.png"
        alt="Astroclaw"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Astroclaw and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `astroclaw onboard` and pairing flows.
  </Card>
...
Astroclaw is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents like Pi. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-astroclaw.jpg" alt="Astroclaw" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.astroclaw/astroclaw.json`.

- If you **do nothing**, Astroclaw uses the bundled Pi binary in RPC mode with per-sender sessions.
