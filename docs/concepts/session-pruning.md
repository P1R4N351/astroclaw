...
Astroclaw also builds a separate idempotent replay view for sessions that
...
Astroclaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Astroclaw does not override them.
