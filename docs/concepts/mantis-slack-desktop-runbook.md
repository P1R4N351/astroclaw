...
Linux desktop, VNC rescue, Slack Web, a real Astroclaw gateway, screenshots,
...
- Mantis artifacts: owned by the Astroclaw run. They live under
...
- remote logs such as `slack-desktop-command.log`, `astroclaw-gateway.log`,
...
- `crabbox.remote_run`: sync, browser launch, Astroclaw install/build or
...
remote status after Mantis has copied metadata proving that the Astroclaw gateway
