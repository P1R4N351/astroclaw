---
summary: "Testing utilities and patterns for Astroclaw plugins"
...
Reference for test utilities, patterns, and lint enforcement for Astroclaw
plugins.
...
These test-helper subpaths are repo-local source entrypoints for Astroclaw's own
bundled plugin tests. They are not package exports for third-party plugins.

**Plugin API mock import:** `astroclaw/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `astroclaw/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `astroclaw/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `astroclaw/plugin-sdk/channel-test-helpers`

**Channel target test import:** `astroclaw/plugin-sdk/channel-target-testing`

**Plugin contract import:** `astroclaw/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `astroclaw/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `astroclaw/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `astroclaw/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `astroclaw/plugin-sdk/test-env`

**Generic fixture import:** `astroclaw/plugin-sdk/test-fixtures`

**Node builtin mock import:** `astroclaw/plugin-sdk/test-node-mocks`

Prefer the focused subpaths below for new plugin tests. The broad
`astroclaw/plugin-sdk/testing` barrel is legacy compatibility only.
...
import { installCommonResolveTargetErrorCases } from "astroclaw/plugin-sdk/channel-target-testing";
...
import { getProviderHttpMocks } from "astroclaw/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "astroclaw/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "astroclaw/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "astroclaw/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled Astroclaw inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "astroclaw/plugin-sdk/plugin-test-runtime";
```
...
Astroclaw's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `astroclaw/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `astroclaw/plugin-sdk` root barrel is rejected
...
Astroclaw uses Vitest with V8 coverage thresholds. For plugin tests:
