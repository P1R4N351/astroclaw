...
read_when:
  - You want Zalo Personal (unofficial) support in Astroclaw
  - You are configuring or developing the zalouser plugin
title: "Zalo personal plugin"
---

Zalo Personal support for Astroclaw via a plugin, using native `zca-js` to automate a normal Zalo user account.
