---
summary: "Contributor guide for adding a new shared capability to the Astroclaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Astroclaw core developers. If you are
...
Use this when Astroclaw needs a new shared domain such as image generation, video generation, or some future vendor-backed feature area.
