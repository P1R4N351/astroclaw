---
summary: "Adds OpenCode Go model provider support to Astroclaw."
read_when:
...
Adds OpenCode Go model provider support to Astroclaw.

## Distribution

- Package: `@astroclaw/opencode-go-provider`
