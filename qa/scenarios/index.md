...
- use `pnpm astroclaw qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Astroclaw QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Astroclaw repo from source + docs before acting.
