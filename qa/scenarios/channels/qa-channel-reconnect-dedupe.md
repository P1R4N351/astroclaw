...
execution:
  ...
  config:
    firstPrompt: "@astroclaw Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@astroclaw Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
