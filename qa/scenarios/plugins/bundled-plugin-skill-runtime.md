...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as ASTROCLAW_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                ASTROCLAW_OAUTH_DIR: path.join(stateDir, "credentials"),
                ASTROCLAW_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
