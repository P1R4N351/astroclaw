...
- **GitHub:** https://github.com/astroclaw/astroclaw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/clawd
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@astroclaw](https://x.com/astroclaw)
...
2. **New features / architecture** → Start a [GitHub Issue](https://github.com/astroclaw/astroclaw/issues/new/choose) or ask in Discord first. Most features are not accepted and should be third party plugins instead using our plugin SDK.
...
- Test locally with your Astroclaw instance
...
- Do not submit test or CI-config fixes for failures already red on `main` CI. If a failure is already visible in the [main branch CI runs](https://github.com/astroclaw/astroclaw/actions), it's a known issue the Maintainer team is tracking, and a PR that only addresses those failures will be closed automatically. If you spot a _new_ regression not yet shown in main CI, report it as an issue first.
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for Astroclaw skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/astroclaw/astroclaw/issues) for
["good first issue"](https://github.com/astroclaw/astroclaw/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
If you're an experienced contributor who wants to help shape Astroclaw's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@astroclaw.ai with:

- Links to your PRs on Astroclaw (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@astroclaw.ai** and we'll route it.
