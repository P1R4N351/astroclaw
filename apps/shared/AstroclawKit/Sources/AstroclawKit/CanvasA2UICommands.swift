...
public enum AstroclawCanvasA2UICommand: String, Codable, Sendable {
...
public struct AstroclawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AstroclawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
