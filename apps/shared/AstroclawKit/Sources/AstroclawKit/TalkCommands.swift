...
public enum AstroclawTalkCommand: String, Codable, Sendable {
...
public struct AstroclawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AstroclawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
