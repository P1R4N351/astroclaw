...
public typealias AstroclawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AstroclawPlatformImage = UIImage
#endif

public struct AstroclawChatUsageCost: Codable, Hashable, Sendable {
...
public struct AstroclawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AstroclawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AstroclawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AstroclawChatMessageContent: Codable, Hashable, Sendable {
...
public struct AstroclawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AstroclawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AstroclawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AstroclawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AstroclawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(AstroclawChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([AstroclawChatMessageContent].self, forKey: .content) {
...
public struct AstroclawChatHistoryPayload: Codable, Sendable {
...
public struct AstroclawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AstroclawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AstroclawSessionPreviewItem]
}

public struct AstroclawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AstroclawSessionPreviewEntry]

    public init(ts: Int, previews: [AstroclawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AstroclawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AstroclawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AstroclawSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let message: AstroclawChatMessage?
...
public struct AstroclawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AstroclawChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct AstroclawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AstroclawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AstroclawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: AstroclawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct AstroclawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
