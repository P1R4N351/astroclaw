...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AstroclawPhotosLatestParams) async throws -> AstroclawPhotosLatestPayload {
        ...
        var results: [AstroclawPhotoPayload] = []
        ...
        return AstroclawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AstroclawPhotoPayload
    {
