...
extension NodeAppModel {
    func resolveCanvasHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__astroclaw__/canvas/").absoluteString
    }
    ...
    func resolveA2UIHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__astroclaw__/a2ui/").absoluteString + "?platform=ios"
    }
