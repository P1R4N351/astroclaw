...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.astroclaw.gateway"
    private static let nodeService = "ai.astroclaw.node"
    private static let talkService = "ai.astroclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.astroclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.astroclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("astroclaw-gateway.log")
    }
