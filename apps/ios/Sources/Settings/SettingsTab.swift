...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AstroclawLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AstroclawLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.astroclaw.ios", category: "GatewaySettings")
        ...
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        ...
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Astroclaw agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Astroclaw agent.")
                        { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while Astroclaw is foregrounded.")
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Astroclaw. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AstroclawLocationMode.off.rawValue)
                            Text("While Using").tag(AstroclawLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AstroclawLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Astroclaw is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Astroclaw", value: DeviceInfoHelper.astroClawVersionString())
                    }
                }
            }
            ...
            .onAppear {
                ...
                .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                    ...
                    guard let mode = AstroclawLocationMode(rawValue: newValue) else { return }
                    Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Astroclaw chat and run /pair approve, then tap Connect again."
        }
