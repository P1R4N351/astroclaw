# Astroclaw iOS Changelog

## 2026.5.17 - 2026-05-17

Maintenance update for the current Astroclaw release.

## 2026.5.12 - 2026-05-12

Maintenance update for the current Astroclaw beta release.
...
Maintenance update for the current Astroclaw development release.
...
First App Store release of Astroclaw for iPhone. Pair with your Astroclaw Gateway to use chat, voice, sharing, and device actions from iOS.
