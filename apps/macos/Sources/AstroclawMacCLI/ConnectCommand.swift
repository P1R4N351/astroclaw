...
struct ConnectOptions {
    ...
    var clientId: String = "astroclaw-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: astroclaw-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "Astroclaw macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("Astroclaw macOS Gateway Connect")
