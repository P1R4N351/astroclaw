...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/astroclaw/astroclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/astroclaw/astroclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://astroclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AstroclawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AstroclawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AstroclawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AstroclawGitCommit") as? String) ??
            "unknown"
    }
