...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .astroclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AstroclawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AstroclawPaths.stateDirURL.path
...
extension Notification.Name {
    static let astroclawSelectSettingsTab = Notification.Name("astroclawSelectSettingsTab")
}
