...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.astroclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AstroclawConfigFile.defaultWorkspaceURL() }
