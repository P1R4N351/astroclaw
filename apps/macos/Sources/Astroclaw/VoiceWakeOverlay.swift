...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.astroclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Astroclaw windows, but below the system’s pop-up menus.
