...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.astroclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> AstroclawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: AstroclawSessionPreviewEntry,
    ...
    private static func cache(payload: AstroclawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: AstroclawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [AstroclawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [AstroclawKit.AnyCodable]) -> [AstroclawChatMessage] {
    ...
    private static func previewText(for message: AstroclawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: AstroclawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: AstroclawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: AstroclawChatMessage) -> String? {
