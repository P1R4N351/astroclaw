...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: AstroclawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": AstroclawProtocol.AnyCodable("start"),
                "name": AstroclawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
