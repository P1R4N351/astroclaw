...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.astroclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Astroclaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__astroclaw__/a2ui/").absoluteString + "?platform=macos"
    }
