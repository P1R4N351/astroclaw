...
function printHelp() {
  console.log(`Usage: node scripts/astroclaw-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes Astroclaw-native performance probe artifacts for CI reports.`);
}
