...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "astroclaw", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Astroclaw. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Astroclaw Issue Label Audit");
