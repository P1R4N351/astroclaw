...
show_usage() {
    cat << EOF
clawlog - Astroclaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Astroclaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Astroclaw logs flow through the macOS unified log (subsystem: ai.astroclaw).
