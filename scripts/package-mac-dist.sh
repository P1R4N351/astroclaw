...
export BUNDLE_ID="${BUNDLE_ID:-ai.astroclaw.mac}"
...
APP="$ROOT_DIR/dist/Astroclaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Astroclaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/Astroclaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Astroclaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Astroclaw-$VERSION.dSYM.zip"
