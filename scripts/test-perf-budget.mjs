...
function parseArgs(argv) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readEnvNumber("ASTROCLAW_TEST_PERF_MAX_WALL_MS"),
      baselineWallMs: readEnvNumber("ASTROCLAW_TEST_PERF_BASELINE_WALL_MS"),
      maxRegressionPct: readEnvNumber("ASTROCLAW_TEST_PERF_MAX_REGRESSION_PCT") ?? 10,
    },
    [
