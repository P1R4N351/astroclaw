...
const opts = parseFlagArgs(
  process.argv.slice(2),
  {
    ...
    maxDurationRegressionPct:
      readEnvNumber("ASTROCLAW_STARTUP_BENCH_MAX_DURATION_REGRESSION_PCT") ?? 20,
    maxFirstOutputRegressionPct:
      readEnvNumber("ASTROCLAW_STARTUP_BENCH_MAX_FIRST_OUTPUT_REGRESSION_PCT") ?? 20,
    maxRssRegressionPct: readEnvNumber("ASTROCLAW_STARTUP_BENCH_MAX_RSS_REGRESSION_PCT") ?? 20,
    skipBaseline: false,
  },
  [
