...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-session-runtime-context-e2e" ASTROCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="astroclaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t astroclaw-session-runtime-context-log.XXXXXX)"
