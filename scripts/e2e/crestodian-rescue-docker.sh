...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-crestodian-rescue-e2e" ASTROCLAW_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="astroclaw-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t astroclaw-crestodian-rescue-log.XXXXXX)"
...
ASTROCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"
