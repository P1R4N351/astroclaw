...
const pluginRecordSnapshot = () => {
  const config = readJson(astroclawPath("astroclaw.json"));
...
function seedInstallState() {
  writeJson(astroclawPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.ASTROCLAW_CONFIG_PATH, { plugins: {} });
  writeJson(astroclawPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Astroclaw plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Astroclaw will continue without it")
  );
}
