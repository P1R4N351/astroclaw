...
astroclaw_e2e_install_package /tmp/astroclaw-plugin-lifecycle-install.log "mounted Astroclaw package" /tmp/npm-prefix
...
pack_root="$(mktemp -d "/tmp/astroclaw-plugin-lifecycle-pack.XXXXXX")"
registry_root="$(mktemp -d "/tmp/astroclaw-plugin-lifecycle-registry.XXXXXX")"
