...
MODEL_REF="${ASTROCLAW_OPENAI_CHAT_TOOLS_MODEL:?missing ASTROCLAW_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/astroclaw-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/astroclaw-openai-chat-tools-client.log"
gateway_pid=""
...
gateway_pid="$(astroclaw_e2e_start_gateway "$entry" "$PORT" "$GATEWAY_LOG")"
...
PORT="$PORT" ASTROCLAW_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \
