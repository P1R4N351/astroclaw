...
export class MacosDiscordSmoke {
  constructor(
    private input: {
      ...
      guest: MacosGuest;
      guestNode: string;
      guestAstroclaw: string;
      guestAstroclawEntry: string;
      runDir: string;
      vmName: string;
    },
  ) {}
...
${this.input.guestNode} ${this.input.guestAstroclawEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestAstroclawEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestAstroclawEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestAstroclawEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestAstroclawEntry} doctor --fix --yes --non-interactive
${this.input.guestNode} ${this.input.guestAstroclawEntry} gateway restart
${this.input.guestNode} ${this.input.guestAstroclawEntry} channels status --probe --json`);
  }
