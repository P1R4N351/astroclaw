...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-release-user-journey-e2e" ASTROCLAW_RELEASE_USER_JOURNEY_E2E_IMAGE)"
SKIP_BUILD="${ASTROCLAW_RELEASE_USER_JOURNEY_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-user-journey "${ASTROCLAW_CURRENT_PACKAGE_TGZ:-}")"
...
ASTROCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-user-journey empty)"
