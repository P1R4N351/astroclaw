...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-crestodian-first-run-e2e" ASTROCLAW_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="astroclaw-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t astroclaw-crestodian-first-run-log.XXXXXX)"
...
ASTROCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"
