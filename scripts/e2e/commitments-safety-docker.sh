...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-commitments-safety-e2e" ASTROCLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="astroclaw-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t astroclaw-commitments-safety-log.XXXXXX)"
