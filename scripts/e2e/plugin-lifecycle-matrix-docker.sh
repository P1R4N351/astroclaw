...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-plugin-lifecycle-matrix-e2e" ASTROCLAW_PLUGIN_LIFECYCLE_MATRIX_E2E_IMAGE)"
SKIP_BUILD="${ASTROCLAW_PLUGIN_LIFECYCLE_MATRIX_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz plugin-lifecycle-matrix "${ASTROCLAW_CURRENT_PACKAGE_TGZ:-}")"
...
ASTROCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 plugin-lifecycle-matrix empty)"
