...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-pi-bundle-mcp-tools-e2e" ASTROCLAW_IMAGE)"
CONTAINER_NAME="astroclaw-pi-bundle-mcp-tools-e2e-$$"
RUN_LOG="$(mktemp -t astroclaw-pi-bundle-mcp-tools-log.XXXXXX)"
...
ASTROCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 pi-bundle-mcp-tools empty)"
