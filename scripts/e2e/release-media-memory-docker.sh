...
IMAGE_NAME="$(docker_e2e_resolve_image "astroclaw-release-media-memory-e2e" ASTROCLAW_RELEASE_MEDIA_MEMORY_E2E_IMAGE)"
SKIP_BUILD="${ASTROCLAW_RELEASE_MEDIA_MEMORY_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-media-memory "${ASTROCLAW_CURRENT_PACKAGE_TGZ:-}")"
...
ASTROCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-media-memory empty)"
