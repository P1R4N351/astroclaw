...
const (
	...
	envDocsI18nProvider      = "ASTROCLAW_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "ASTROCLAW_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<astroclaw_docs_i18n_input>", "</astroclaw_docs_i18n_input>"} {
