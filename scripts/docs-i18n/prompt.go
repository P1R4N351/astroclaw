...
- Keep product names in English: Astroclaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Astroclaw Gateway, use “Gateway 网关”.
