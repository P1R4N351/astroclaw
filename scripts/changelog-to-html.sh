...
if [[ -z "$version_content" ]]; then
  echo "<h2>Astroclaw $VERSION</h2>"
  echo "<p>Latest Astroclaw update.</p>"
  echo "<p><a href=\"https://github.com/astroclaw/astroclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
