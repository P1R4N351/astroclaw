---
name: astroclaw-ghsa-maintainer
description: Inspect, patch, validate, publish, or confirm Astroclaw GHSA security advisories and private-fork state.
---

# Astroclaw GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `astroclaw-release-maintainer`.
...
```bash
fork=$(gh api /repos/astroclaw/astroclaw/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/astroclaw/astroclaw/security-advisories/<GHSA> \
