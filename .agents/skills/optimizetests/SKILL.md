---
name: optimizetests
description: Optimize Astroclaw slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real Astroclaw test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `ASTROCLAW_VITEST_IMPORT_DURATIONS=1 ASTROCLAW_VITEST_PRINT_IMPORT_BREAKDOWN=1`
