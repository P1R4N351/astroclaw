---
name: astroclaw-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Astroclaw GitHub Secret Scanning alerts in issues or PRs.
---

# Astroclaw Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/astroclaw/astroclaw/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/astroclaw-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/astroclaw/astroclaw/issues/63101#issuecomment-xxx",
