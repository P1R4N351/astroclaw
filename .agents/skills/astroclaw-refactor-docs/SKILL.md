---
name: astroclaw-refactor-docs
description: Refactor an existing Astroclaw docs page with source-audited preservation, restructuring, and verification.
---

# Astroclaw Refactor Docs

## Overview

Use this skill when the user gives a target Astroclaw docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `astroclaw-docs`: use that skill for style, page types,
...
Read `../astroclaw-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `astroclaw-docs`.
