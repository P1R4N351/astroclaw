...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/astroclaw");
      expect(html).toBe(
        '<p>Visit <a href="http://github.com/astroclaw" rel="noreferrer noopener" target="_blank">http://github.com/astroclaw</a></p>\n',
      );
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Astroclaw中文](https://docs.astroclaw.ai)");
      expect(html).toBe(
        '<p><a href="https://docs.astroclaw.ai" rel="noreferrer noopener" target="_blank">Astroclaw中文</a></p>\n',
      );
    });
