...
describe("renderSkills", () => {
  ...
  it("opens detail dialogs and routes ClawHub actions", async () => {
          ...
          clawhubResults: [
            {
              ...
              slug: "github",
              displayName: "GitHub",
              summary: "GitHub integration for Astroclaw",
              version: "1.2.3",
            },
          ],
          onClawHubDetailOpen,
    ...
    expect(resultItem?.querySelector(".list-sub")?.textContent?.trim()).toBe(
      "GitHub integration for Astroclaw",
    );
    ...
    expect(normalizeText(container.querySelector(".md-preview-dialog__body")!)).toBe(
      "GitHub integration for Astroclaw By Astroclaw (@astroclaw) Latest: v1.2.3 Added search support Platforms: macos, linux Install GitHub",
    );
