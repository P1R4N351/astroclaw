...
function buildFeedback(params: {
  ...
  const docsHref = params.docsHref ?? "https://docs.astroclaw.ai/web/dashboard";
  return {
    kind: params.kind,
...
export function resolveLoginFailureFeedback(
  ...
  if (pairing) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.astroclaw.ai/web/control-ui#device-pairing-first-connection",
      titleKey:
  ...
  if (shouldShowInsecureContextHint(false, rawError, lastErrorCode)) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.astroclaw.ai/web/control-ui#insecure-http",
    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Astroclaw" />
          <div class="login-gate__title">Astroclaw</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="ASTROCLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
