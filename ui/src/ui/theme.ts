...
export type ThemeName = "claw" | "knot" | "dash" | "piranesi" | "custom";
...
export const VALID_THEME_NAMES = new Set<ThemeName>(["claw", "knot", "dash", "piranesi", "custom"]);
...
export function resolveTheme(theme: ThemeName, mode: ThemeMode): ResolvedTheme {
  ...
  if (theme === "piranesi") {
    return resolvedMode === "light" ? "piranesi-light" : "piranesi";
  }
