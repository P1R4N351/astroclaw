...
const LEGACY_USAGE_DATE_PARAMS_STORAGE_KEY = "astroclaw.control.usage.date-params.v1";
const LEGACY_USAGE_SCOPE_PARAMS_STORAGE_KEY = "astroclaw.control.usage.scope-params.v1";
