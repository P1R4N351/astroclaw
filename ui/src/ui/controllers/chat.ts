...
const SYNTHETIC_TRANSCRIPT_REPAIR_RESULT =
  "[astroclaw] missing tool result in session history; inserted synthetic error result for transcript repair.";
...
function hasTranscriptMeta(message: unknown): boolean {
  return Boolean(
    ...
    (message as { __astroclaw?: unknown }).__astroclaw &&
    typeof (message as { __astroclaw?: unknown }).__astroclaw === "object",
  );
}
...
export function handleChatEvent(state: ChatState, payload?: ChatEventPayload) {
  ...
  // See https://github.com/astroclaw/astroclaw/issues/1909
