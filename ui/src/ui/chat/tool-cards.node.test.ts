...
*No output — tool completed successfully.*`);
  ...
  it("extracts canvas handle payloads into canvas previews", () => {
    const [card] = extractToolCards(
      {
        ...
        content: JSON.stringify({
          ...
          view: {
            backend: "canvas",
            id: "cv_inline",
            url: "/__astroclaw__/canvas/documents/cv_inline/index.html",
          },
          presentation: {
    ...
    expect(card?.preview?.url).toBe("/__astroclaw__/canvas/documents/cv_inline/index.html");
    ...
    const cases = [
      {
        ...
        content: JSON.stringify({
          ...
          view: {
            backend: "canvas",
            id: "cv_tool_card",
            url: "/__astroclaw__/canvas/documents/cv_tool_card/index.html",
          },
          presentation: {
            target: "tool_card",
