...
export const pl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z astroclaw dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Wklej token z astroclaw dashboard --no-open albo wpisz skonfigurowane hasło.",
        stepGenerate:
          "Jeśli token nie jest skonfigurowany, uruchom astroclaw doctor --generate-gateway-token na hoście Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Uruchom astroclaw dashboard --no-open i otwórz świeży URL albo wklej jego token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Uruchom astroclaw devices list na hoście Gateway.",
        stepApproveId: "Zatwierdź to żądanie: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Otwórz ponownie udostępniany dashboard poleceniem astroclaw dashboard, aby UI i Gateway pochodziły z tej samej instalacji.",
        stepDevUi:
          "Jeśli używasz pnpm ui:dev, przebuduj lub uruchom ponownie UI dev względem bieżącego checkoutu.",
        stepRestart:
          "Zrestartuj Gateway po aktualizacji Astroclaw, aby udostępniał bieżący protokół.",
      },
      network: {
        ...
        stepGateway:
          "Potwierdź, że Gateway działa, używając astroclaw status lub astroclaw gateway run.",
        stepUrl: "Sprawdź URL WebSocket i użyj wss://, gdy Gateway jest za HTTPS/Tailscale Serve.",
        stepDashboard:
          "Otwórz ponownie dashboard przez astroclaw dashboard --no-open, aby skopiować bieżący URL i szczegóły auth.",
      },
    },
  },
  chat: {
