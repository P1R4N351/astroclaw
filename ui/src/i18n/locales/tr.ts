...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "astroclaw.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde astroclaw dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — astroclaw models auth ile yeniden kimlik doğrulayın",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "astroclaw dashboard --no-open çıktısındaki tokenı yapıştırın veya yapılandırılmış parolayı girin.",
        stepGenerate:
          "Token yapılandırılmamışsa Gateway ana makinesinde astroclaw doctor --generate-gateway-token çalıştırın.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "astroclaw dashboard --no-open çalıştırın ve yeni URL’yi açın veya tokenını yapıştırın.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Gateway hostunda astroclaw devices list çalıştırın.",
        stepApproveId: "Bu isteği onaylayın: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "UI ve Gateway aynı kurulumdan gelsin diye sunulan dashboardı astroclaw dashboard ile yeniden açın.",
        stepDevUi:
          "pnpm ui:dev kullanıyorsanız geliştirme UI’sini mevcut checkouta göre yeniden derleyin veya yeniden başlatın.",
        stepRestart:
          "Astroclaw güncellemesinden sonra Gateway’i yeniden başlatın, böylece güncel protokolü sunsun.",
      },
      network: {
        title: "Bağlanılamadı",
        summary:
        ...
        stepGateway:
          "astroclaw status veya astroclaw gateway run ile Gateway’in çalıştığını doğrulayın.",
        stepUrl:
          "WebSocket URL’sini kontrol edin ve Gateway HTTPS/Tailscale Serve arkasındaysa wss:// kullanın.",
        stepDashboard:
          "Geçerli URL ve auth ayrıntılarını yeniden kopyalamak için dashboardı astroclaw dashboard --no-open ile yeniden açın.",
      },
    },
  },
  chat: {
