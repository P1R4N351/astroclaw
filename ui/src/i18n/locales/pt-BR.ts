...
export const pt_BR: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando astroclaw dashboard --no-open no desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentique novamente com astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Cole o token de astroclaw dashboard --no-open ou informe a senha configurada.",
        stepGenerate:
          "Se nenhum token estiver configurado, execute astroclaw doctor --generate-gateway-token no host do Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Execute astroclaw dashboard --no-open e abra o novo URL ou cole seu token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Execute astroclaw devices list no host do Gateway.",
        stepApproveId: "Aprove esta solicitação: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reabra o dashboard servido com astroclaw dashboard para que UI e Gateway venham da mesma instalação.",
        stepDevUi:
          "Se estiver usando pnpm ui:dev, reconstrua ou reinicie a UI de desenvolvimento com o checkout atual.",
        stepRestart:
          "Reinicie o Gateway depois de atualizar o Astroclaw para que ele sirva o protocolo atual.",
      },
      network: {
        ...
        stepGateway:
          "Confirme que o Gateway está em execução com astroclaw status ou astroclaw gateway run.",
        stepUrl:
          "Verifique o URL de WebSocket e use wss:// quando o Gateway estiver atrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reabra o dashboard com astroclaw dashboard --no-open para copiar novamente o URL atual e os detalhes de auth.",
      },
    },
  },
  chat: {
