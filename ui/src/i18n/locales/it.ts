...
export const it: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Modifica astroclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Su mobile? Copia l'URL completo (incluso #token=...) da astroclaw dashboard --no-open sul desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — riautenticati con astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Incolla il token da astroclaw dashboard --no-open oppure inserisci la password configurata.",
        stepGenerate:
          "Se non è configurato alcun token, esegui astroclaw doctor --generate-gateway-token sull’host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Esegui astroclaw dashboard --no-open e apri il nuovo URL oppure incolla il suo token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Esegui astroclaw devices list sull’host Gateway.",
        stepApproveId: "Approva questa richiesta: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Riapri il dashboard servito con astroclaw dashboard in modo che UI e Gateway provengano dalla stessa installazione.",
        stepDevUi:
          "Se usi pnpm ui:dev, ricompila o riavvia la UI di sviluppo contro il checkout corrente.",
        stepRestart:
          "Riavvia il Gateway dopo aver aggiornato Astroclaw affinché serva il protocollo corrente.",
      },
      network: {
        ...
        stepGateway:
          "Conferma che il Gateway sia in esecuzione con astroclaw status o astroclaw gateway run.",
        stepUrl:
          "Controlla l’URL WebSocket e usa wss:// quando il Gateway è dietro HTTPS/Tailscale Serve.",
        stepDashboard:
          "Riapri il dashboard con astroclaw dashboard --no-open per ricopiare l’URL corrente e i dettagli auth.",
      },
    },
  },
  chat: {
