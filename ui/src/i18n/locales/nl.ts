...
export const nl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Op mobiel? Kopieer de volledige URL (inclusief #token=...) vanuit astroclaw dashboard --no-open op je desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — authenticeer opnieuw met astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Plak het token uit astroclaw dashboard --no-open of voer het geconfigureerde wachtwoord in.",
        stepGenerate:
          "Als er geen token is geconfigureerd, voer dan astroclaw doctor --generate-gateway-token uit op de Gateway-host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Voer astroclaw dashboard --no-open uit en open de nieuwe URL of plak het token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Voer astroclaw devices list uit op de Gateway-host.",
        stepApproveId: "Keur deze aanvraag goed: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Open het geserveerde dashboard opnieuw met astroclaw dashboard zodat UI en Gateway uit dezelfde installatie komen.",
        stepDevUi:
          "Als je pnpm ui:dev gebruikt, bouw of herstart de dev-UI tegen de huidige checkout.",
        stepRestart:
          "Herstart de Gateway na het bijwerken van Astroclaw zodat het huidige protocol wordt geserveerd.",
      },
      network: {
        ...
        stepGateway: "Bevestig dat de Gateway draait met astroclaw status of astroclaw gateway run.",
        stepUrl:
          "Controleer de WebSocket-URL en gebruik wss:// wanneer de Gateway achter HTTPS/Tailscale Serve staat.",
        stepDashboard:
          "Open het dashboard opnieuw met astroclaw dashboard --no-open om de huidige URL en authdetails opnieuw te kopiëren.",
      },
    },
  },
  chat: {
