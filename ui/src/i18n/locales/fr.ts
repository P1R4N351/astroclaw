...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Modifier astroclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Sur mobile ? Copiez l’URL complète (y compris #token=...) depuis astroclaw dashboard --no-open sur votre ordinateur.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — réauthentifiez-vous avec astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Collez le jeton de astroclaw dashboard --no-open ou saisissez le mot de passe configuré.",
        stepGenerate:
          "Si aucun jeton n’est configuré, exécutez astroclaw doctor --generate-gateway-token sur l’hôte Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Exécutez astroclaw dashboard --no-open et ouvrez la nouvelle URL ou collez son jeton.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Exécutez astroclaw devices list sur l’hôte Gateway.",
        stepApproveId: "Approuvez cette demande : astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Rouvrez le dashboard servi avec astroclaw dashboard afin que l’UI et le Gateway viennent de la même installation.",
        stepDevUi:
          "Si vous utilisez pnpm ui:dev, reconstruisez ou redémarrez l’UI de développement avec le checkout actuel.",
        stepRestart:
          "Redémarrez le Gateway après la mise à jour d’Astroclaw afin qu’il serve le protocole actuel.",
      },
      network: {
        ...
        stepGateway:
          "Confirmez que le Gateway fonctionne avec astroclaw status ou astroclaw gateway run.",
        stepUrl:
          "Vérifiez l’URL WebSocket et utilisez wss:// lorsque le Gateway est derrière HTTPS/Tailscale Serve.",
        stepDashboard:
          "Rouvrez le dashboard avec astroclaw dashboard --no-open pour recopier l’URL actuelle et les détails d’authentification.",
      },
    },
  },
  chat: {
