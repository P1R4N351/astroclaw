...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Редагування astroclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "На мобільному? Скопіюйте повний URL (включно з #token=...) з astroclaw dashboard --no-open на вашому комп’ютері.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — повторно виконайте авторизацію через astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Вставте токен з astroclaw dashboard --no-open або введіть налаштований пароль.",
        stepGenerate:
          "Якщо токен не налаштовано, виконайте astroclaw doctor --generate-gateway-token на хості Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Виконайте astroclaw dashboard --no-open і відкрийте свіжий URL або вставте його токен.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Виконайте astroclaw devices list на хості Gateway.",
        stepApproveId: "Схваліть цей запит: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Знову відкрийте наданий dashboard через astroclaw dashboard, щоб UI і Gateway походили з однієї інсталяції.",
        stepDevUi:
          "Якщо використовуєте pnpm ui:dev, перебудуйте або перезапустіть dev UI з поточного checkout.",
        stepRestart:
          "Перезапустіть Gateway після оновлення Astroclaw, щоб він надавав поточний протокол.",
      },
      network: {
        ...
        stepGateway:
          "Підтвердьте, що Gateway працює, через astroclaw status або astroclaw gateway run.",
        stepUrl:
          "Перевірте WebSocket URL і використовуйте wss://, коли Gateway знаходиться за HTTPS/Tailscale Serve.",
        stepDashboard:
          "Знову відкрийте dashboard через astroclaw dashboard --no-open, щоб повторно скопіювати поточний URL і деталі auth.",
      },
    },
  },
  chat: {
