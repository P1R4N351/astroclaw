...
export const id: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Di seluler? Salin URL lengkap (termasuk #token=...) dari astroclaw dashboard --no-open di desktop Anda.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentikasi ulang dengan astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Tempel token dari astroclaw dashboard --no-open atau masukkan kata sandi yang dikonfigurasi.",
        stepGenerate:
          "Jika belum ada token yang dikonfigurasi, jalankan astroclaw doctor --generate-gateway-token di host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Jalankan astroclaw dashboard --no-open lalu buka URL baru atau tempel tokennya.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Jalankan astroclaw devices list di host Gateway.",
        stepApproveId: "Setujui permintaan ini: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Buka kembali dashboard yang disajikan dengan astroclaw dashboard agar UI dan Gateway berasal dari instalasi yang sama.",
        stepDevUi:
          "Jika menggunakan pnpm ui:dev, bangun ulang atau mulai ulang UI dev terhadap checkout saat ini.",
        stepRestart:
          "Mulai ulang Gateway setelah memperbarui Astroclaw agar menyajikan protokol saat ini.",
      },
      network: {
        ...
        stepGateway: "Pastikan Gateway berjalan dengan astroclaw status atau astroclaw gateway run.",
        stepUrl:
          "Periksa URL WebSocket dan gunakan wss:// saat Gateway berada di belakang HTTPS/Tailscale Serve.",
        stepDashboard:
          "Buka kembali dashboard dengan astroclaw dashboard --no-open untuk menyalin ulang URL dan detail auth saat ini.",
      },
    },
  },
  chat: {
