...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.astroclaw/astroclaw.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde astroclaw dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con astroclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Pega el token de astroclaw dashboard --no-open o introduce la contraseña configurada.",
        stepGenerate:
          "Si no hay token configurado, ejecuta astroclaw doctor --generate-gateway-token en el host del Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Ejecuta astroclaw dashboard --no-open y abre la URL nueva o pega su token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Ejecuta astroclaw devices list en el host del Gateway.",
        stepApproveId: "Aprueba esta solicitud: astroclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Vuelve a abrir el dashboard servido con astroclaw dashboard para que UI y Gateway provengan de la misma instalación.",
        stepDevUi:
          "Si usas pnpm ui:dev, reconstruye o reinicia la UI de desarrollo contra el checkout actual.",
        stepRestart:
          "Reinicia el Gateway después de actualizar Astroclaw para que sirva el protocolo actual.",
      },
      network: {
        ...
        stepGateway:
          "Confirma que el Gateway esté en ejecución con astroclaw status u astroclaw gateway run.",
        stepUrl:
          "Revisa la URL de WebSocket y usa wss:// cuando el Gateway esté detrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Vuelve a abrir el dashboard con astroclaw dashboard --no-open para copiar la URL y los detalles de autenticación actuales.",
      },
    },
  },
  chat: {
