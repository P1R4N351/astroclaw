import { asNullableRecord as recordOrNull } from "@astroclaw/normalization-core/record-coerce";
import { normalizeOptionalString as stringValue } from "@astroclaw/normalization-core/string-coerce";
