        ...
        ? renderSettingsSection(
            ...
            html`
              ${this.toggle(
                ...
                sync.enabled,
                "cookieSyncEnabled",
                t("configPage.deviceSettings.cookieSyncHint"),
              )}
              ${renderSettingsRow({
      ...
      ${renderSettingsSection(
        ...
        html`
          ${this.toggle(
            ...
            app.showDockIcon,
            "showDockIcon",
            t("configPage.deviceSettings.showDockIconHint"),
          )}
          ${this.toggle(
            "app.iconAnimationsEnabled",
            app.iconAnimationsEnabled,
            "iconAnimations",
            t("configPage.deviceSettings.iconAnimationsHint"),
          )}
          ${this.toggle(
            "app.launchAtLogin",
            app.launchAtLogin,
            "launchAtLogin",
            app.launchAtLoginAvailable
              ? undefined
          ...
          ${this.toggle(
            ...
            app.quickChatEnabled,
            "quickChat",
            t("configPage.deviceSettings.quickChatHint"),
          )}
          ${renderSettingsRow({
      ...
      ${renderSettingsSection(
        ...
        html`
          ${this.toggle(
            ...
            capabilities.canvasEnabled,
            "canvas",
            t("configPage.deviceSettings.canvasHint"),
          )}
          ${this.toggle(
            "capabilities.cameraEnabled",
            capabilities.cameraEnabled,
            "camera",
            t("configPage.deviceSettings.cameraHint"),
          )}
          ${this.toggle(
          ...
          ${this.toggle(
            ...
            capabilities.peekabooBridgeEnabled,
            "peekabooBridge",
            t("configPage.deviceSettings.peekabooBridgeHint"),
            !capabilities.computerControlEnabled,
          )}
        `,
      )}
          ...
          ${app.debugPaneEnabled
            ? renderSettingsRow({
                ...
                control: html`<button
                  type="button"
                  class="btn"
                  @click=${() => capability?.openPanel("debug")}
                >
