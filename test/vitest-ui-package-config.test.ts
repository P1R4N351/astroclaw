...
describe("ui package vitest config", () => {
  ...
  it.each([
    ["@astroclaw/gateway-client/scope-upgrade", "packages/gateway-client/src/scope-upgrade.ts"],
    ["astroclaw/plugin-sdk/control-ui", "src/plugin-sdk/control-ui.ts"],
    ["astroclaw/plugin-sdk/extension-shared", "src/plugin-sdk/extension-shared.ts"],
    ["astroclaw/plugin-sdk/string-coerce-runtime", "src/plugin-sdk/string-coerce-runtime.ts"],
    ["astroclaw/plugin-sdk/test-fixtures", "src/plugin-sdk/test-fixtures.ts"],
