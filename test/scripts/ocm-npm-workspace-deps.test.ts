...
`;
  ...
  it("rejects package archives with an unconfigured workspace dependency", () => {
    const packageJson = {
      dependencies: {
        "@astroclaw/normalization-core": "workspace:*",
      },
    };
    ...
    try {
      ...
      writeFileSync(
        ...
        `${JSON.stringify({
          ...
          version: "1.0.0",
          main: "index.js",
          dependencies: { "@astroclaw/normalization-core": "workspace:*" },
        })}\n`,
      );
      ...
      writeFileSync(
        ...
        `${JSON.stringify({
          name: "@astroclaw/normalization-core",
          version: "1.0.0",
          main: "index.js",
        })}\n`,
      );
      ...
      expect(
        JSON.parse(readFileSync(join(installDir, "node_modules/@openclaw/ai/package.json"), "utf8"))
          .dependencies["@astroclaw/normalization-core"],
      ).toBe("1.0.0");
    } finally {
      rmSync(root, { force: true, recursive: true });
    }
