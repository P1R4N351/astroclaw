...
async function loadRuntime() {
  const [qa, sessions, store, transcript, guards, evidence, writer, hostStore] = await Promise.all([
    ...
    import("astroclaw/plugin-sdk/agent-sessions"),
    import("astroclaw/plugin-sdk/session-store-runtime"),
    import("astroclaw/plugin-sdk/session-transcript-runtime"),
    import("astroclaw/plugin-sdk/string-coerce-runtime"),
