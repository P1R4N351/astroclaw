...
import { ProtocolSchemas } from "@astroclaw/gateway-protocol/schema";
...
async function packAndInspectProtocol(params: {
  ...
  assert.equal(packageJson.name, "@astroclaw/gateway-protocol");
  ...
  return {
    consumer: {
      installed: true,
      packageSpecifier: "@astroclaw/gateway-protocol",
      schemaSpecifier: "@astroclaw/gateway-protocol/schema",
    },
