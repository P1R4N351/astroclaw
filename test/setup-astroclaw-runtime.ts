...
const WORKER_RUNTIME_STATE = Symbol.for("astroclaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("astroclaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("astroclaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: AstroclawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
