...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in Astroclaw config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `astroclaw doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  astroclaw config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: ASTROCLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in Astroclaw config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in Astroclaw config",
    ...
    security: {
      ...
      beta: "Astroclaw is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run Astroclaw.",
      learnMore: "Learn more",
      notMultitenant: "Astroclaw is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, Astroclaw is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.astroclaw.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "Astroclaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so Astroclaw can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for Astroclaw",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: astroclaw channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL Astroclaw uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "Astroclaw"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var ASTROCLAW_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: ASTROCLAW_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to Astroclaw with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with astroclaw configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.astroclaw.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control Astroclaw.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control Astroclaw.",
      ...
      gatewayTokenStored:
        "Stored in: $ASTROCLAW_CONFIG_PATH (default: ~/.astroclaw/astroclaw.json) under gateway.auth.token, or in ASTROCLAW_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control Astroclaw.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control Astroclaw.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.astroclaw.ai/security",
      ...
      webDocs: "Docs: https://docs.astroclaw.ai/tools/web",
      ...
      whatNow: 'What now: https://astroclaw.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.astroclaw.ai/concepts/agent-workspace",
