...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@astroclaw", { botUsername: "astroclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@astroclaw args", {
        botUsername: "astroclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@astroclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "astroclaw" })).toBe(
      "/help@otherbot",
    );
  });
