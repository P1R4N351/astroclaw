...
function resolveMentionPatterns(cfg: AstroclawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AstroclawConfig | undefined, agentId?: string): RegExp[] {
