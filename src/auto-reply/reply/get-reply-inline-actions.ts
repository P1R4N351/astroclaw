...
type AstroclawToolsRuntime = typeof import("../../agents/astroclaw-tools.runtime.js");
...
const astroClawToolsRuntimeLoader = createLazyImportLoader<AstroclawToolsRuntime>(
  () => import("../../agents/astroclaw-tools.runtime.js"),
);
...
function loadAstroclawToolsRuntime(): Promise<AstroclawToolsRuntime> {
  return astroClawToolsRuntimeLoader.load();
}
...
export async function handleInlineActions(params: {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const { createAstroclawTools } = await loadAstroclawToolsRuntime();
