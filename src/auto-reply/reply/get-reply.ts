...
import { type AstroclawConfig, getRuntimeConfig } from "../../config/config.js";
...
function resolveHeartbeatAckMaxChars(cfg: AstroclawConfig, agentId: string): number {
...
export async function getReplyFromConfig(
  ...
  const isFastTestEnv = process.env.ASTROCLAW_TEST_FAST === "1";
