import { asPositiveFiniteNumber as normalizePairingQrExpiresAtMs } from "@astroclaw/normalization-core/number-coercion";
import { readNonBlankString as normalizeTtsSupplementSpokenText } from "@astroclaw/normalization-core/string-coerce";
