...
export function resolveSubagentToolPolicy(cfg?: AstroclawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: AstroclawConfig["tools"]): string[] | undefined {
...
function detectImplicitProfileGrants(params: {
  globalTools?: AstroclawConfig["tools"];
