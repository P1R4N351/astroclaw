...
const RECOVERABLE_WAIT_RETRY_DELAY_MS = process.env.ASTROCLAW_TEST_FAST === "1" ? 25 : 5_000;
...
export function createSubagentRunManager(params: {
  ...
  resolveSubagentWaitTimeoutMs(cfg: AstroclawConfig, runTimeoutSeconds?: number): number;
