...
export const DEFAULT_SANDBOX_IMAGE = "astroclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "astroclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "astroclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "astroclaw-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "astroclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "astroclaw-sandbox-browser";
