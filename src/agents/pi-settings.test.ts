...
describe("isSilentOverflowProneModel", () => {
  ...
  // astroclaw#75799 reporter's setup: an OpenAI-compatible in-house gateway
  ...
  // Astroclaw's preemptive compaction continues to handle real overflow.
...
describe("applyPiAutoCompactionGuard", () => {
  // Direct repro of astroclaw#75799: pi-ai's silent-overflow detection misfires
  ...
  // state.messages intact; Astroclaw's preemptive compaction continues to
