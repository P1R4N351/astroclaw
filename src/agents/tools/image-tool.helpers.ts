...
export function coerceImageModelConfig(cfg?: AstroclawConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: AstroclawConfig; ref: string }): string[] {
