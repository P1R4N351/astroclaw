...
// Keep the schema local to avoid a circular import through acp-spawn/astroclaw-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: AstroclawConfig }) {
