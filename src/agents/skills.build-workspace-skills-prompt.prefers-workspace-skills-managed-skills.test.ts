...
import type { AstroclawSkillMetadata, SkillEntry } from "./skills/types.js";
...
const fixtureSuite = createFixtureSuite("astroclaw-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: AstroclawSkillMetadata;
}): SkillEntry {
