...
type CreateAstroclawToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateAstroclawToolsOpts) {
...
vi.mock("../config/sessions.js", () => ({
  ...
  resolveStorePath: () => "/tmp/astroclaw-sessions-spawn-test-store.json",
