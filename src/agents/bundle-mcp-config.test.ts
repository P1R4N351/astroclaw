...
describe("loadMergedBundleMcpConfig", () => {
  it("lets Astroclaw mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps Astroclaw transports to downstream CLI types when requested", () => {
    expect(
