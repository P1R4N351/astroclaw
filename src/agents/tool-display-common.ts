import { parseStrictFiniteNumber } from "@astroclaw/normalization-core/number-coercion";
/**
 * Shared compact tool-call display helpers.
 * Redacts and summarizes arguments into short labels/details for chat and UI
 * tool update streams.
 */
import { asOptionalObjectRecord as asRecord } from "@astroclaw/normalization-core/record-coerce";
import {
