...
function isTranscriptOnlyAstroclawAssistantMessage(message: AgentMessage | undefined): boolean {
...
export function handleMessageStart(
  ...
  if (msg?.role !== "assistant" || isTranscriptOnlyAstroclawAssistantMessage(msg)) {
    return;
  }
