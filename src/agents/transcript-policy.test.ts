      ...
      return {
        buildReplayPolicy: (context?: {
          ...
          switch (provider) {
            case "env-sensitive":
              return {
                sanitizeToolCallIds: context?.env?.ASTROCLAW_TEST_TRANSCRIPT_POLICY === "strict",
                ...(context?.env?.ASTROCLAW_TEST_TRANSCRIPT_POLICY === "strict"
...
describe("resolveTranscriptPolicy", () => {
  ...
  it("does not reuse cached replay policies across custom env objects", () => {
    ...
    const strictEnv = {
      ...process.env,
      ASTROCLAW_TEST_TRANSCRIPT_POLICY: "strict",
    };
    const looseEnv = {
      ...process.env,
      ASTROCLAW_TEST_TRANSCRIPT_POLICY: "loose",
    };
