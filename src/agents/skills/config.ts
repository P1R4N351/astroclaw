...
export function isConfigPathTruthy(config: AstroclawConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["astroclaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: AstroclawConfig): string[] | undefined {
