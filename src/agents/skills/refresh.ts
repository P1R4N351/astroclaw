...
function resolveWatchPaths(workspaceDir: string, config?: AstroclawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AstroclawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AstroclawConfig }) {
