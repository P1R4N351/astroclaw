...
function hasConfiguredSkillApiKeyRef(config?: AstroclawConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: AstroclawConfig): AstroclawConfig | undefined {
