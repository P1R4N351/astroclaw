...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "astroclaw-sbx-test",
    runtimeLabel: params.containerName ?? "astroclaw-sbx-test",
    containerName: params.containerName ?? "astroclaw-sbx-test",
