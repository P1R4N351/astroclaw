...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.astroclaw/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "astroclaw doctor" and "astroclaw approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
