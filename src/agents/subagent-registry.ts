...
const STALE_ACTIVE_SUBAGENT_GRACE_MS = process.env.ASTROCLAW_TEST_FAST === "1" ? 1_000 : 60_000;
...
function resolveSubagentWaitTimeoutMs(cfg: AstroclawConfig, runTimeoutSeconds?: number) {
