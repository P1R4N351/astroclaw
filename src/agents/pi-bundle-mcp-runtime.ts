...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("astroclaw.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: AstroclawConfig): number {
