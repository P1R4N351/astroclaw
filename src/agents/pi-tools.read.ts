...
function resolveAdaptiveReadMaxBytes(options?: AstroclawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAstroclawReadTool(base, {
...
export function createAstroclawReadTool(
  base: AnyAgentTool,
  options?: AstroclawReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
