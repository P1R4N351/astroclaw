import { readNonEmptyStringPreservingWhitespace as readOptionalNonEmptyString } from "@astroclaw/normalization-core/string-coerce";
import { truncateUtf16Safe, truncateWithMarker } from "@astroclaw/normalization-core/utf16-slice";
import type {
  JsonValue,
