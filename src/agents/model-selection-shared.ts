...
export function buildConfiguredModelCatalog(params: { cfg: AstroclawConfig }): ModelCatalogEntry[] {
...
export function parseConfiguredModelVisibilityEntries(params: { cfg?: AstroclawConfig }): {
