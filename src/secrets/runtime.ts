...
function hasConfiguredPluginEntries(config: AstroclawConfig): boolean {
...
function hasConfiguredChannelEntries(config: AstroclawConfig): boolean {
...
function hasRuntimeWebToolConfigSurface(config: AstroclawConfig): boolean {
