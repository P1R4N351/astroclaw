...
function resolveResolutionLimits(config: AstroclawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: AstroclawConfig): SecretProviderConfig {
