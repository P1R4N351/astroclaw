...
import type { ConfigValidationIssue, AstroclawConfig } from "../../config/types.astroclaw.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: AstroclawConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, getRuntimeConfig() and loadAstroclawPlugins() (called inside
