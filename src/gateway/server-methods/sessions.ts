...
function resolveGatewaySessionTargetFromKey(key: string, cfg: AstroclawConfig) {
...
function isAgentMainSessionKey(cfg: AstroclawConfig, sessionKey: string): boolean {
