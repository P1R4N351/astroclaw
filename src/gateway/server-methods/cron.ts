...
function listConfiguredAnnounceChannelIds(cfg: AstroclawConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: AstroclawConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: AstroclawConfig, jobCreate: CronJobCreate) {
