 ...
 *
 * @see https://github.com/astroclaw/astroclaw/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an AstroclawConfig.
 */
export function timestampOptsFromConfig(cfg: AstroclawConfig): TimestampInjectionOptions {
  return {
