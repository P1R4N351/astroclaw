...
function createSnapshot(config: AstroclawConfig): PreparedSecretsRuntimeSnapshot {
  return {
...
// set ASTROCLAW_SKIP_CHANNELS / ASTROCLAW_SKIP_PROVIDERS at module load. When a
