...
export function hasAmbiguousGatewayAuthModeConfig(cfg: AstroclawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: AstroclawConfig): void {
