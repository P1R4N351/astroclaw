...
function resolveSessionKey(params: { cfg: AstroclawConfig; input: ToolsInvokeInput }): string {
...
function resolveMemoryToolDisableReasons(cfg: AstroclawConfig): string[] {
