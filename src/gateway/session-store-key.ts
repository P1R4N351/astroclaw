...
function resolveDefaultStoreAgentId(cfg: AstroclawConfig): string {
...
export function resolveSessionStoreAgentId(cfg: AstroclawConfig, canonicalKey: string): string {
