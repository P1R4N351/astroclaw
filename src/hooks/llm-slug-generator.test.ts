...
vi.mock("../agents/agent-scope.js", () => ({
  ...
  resolveAgentWorkspaceDir: vi.fn(() => "/tmp/astroclaw-agent"),
  resolveAgentDir: vi.fn(() => "/tmp/astroclaw-agent/.astroclaw-agent"),
  resolveAgentEffectiveModelPrimary: vi.fn((cfg: AstroclawConfig) => {
