...
import type { ModelDefinitionConfig, AstroclawConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: AstroclawConfig) => AstroclawConfig;
  applyLitellmProviderConfig: (cfg: AstroclawConfig) => AstroclawConfig;
