...
export type TtsRuntimeFacade = {
  _test: TtsTestFacade;
  buildTtsSystemPromptHint: (cfg: AstroclawConfig, agentId?: string) => string | undefined;
  ...
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: AstroclawConfig) => TtsProvider[];
