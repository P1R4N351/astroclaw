...
import type { BrowserConfig, BrowserProfileConfig, AstroclawConfig } from "../config/config.js";
import type { SsrFPolicy } from "../infra/net/ssrf.js";
import { resolvePreferredAstroclawTmpDir } from "../infra/tmp-astroclaw-dir.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

export const DEFAULT_ASTROCLAW_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_ASTROCLAW_BROWSER_COLOR = "#FF4500";
export const DEFAULT_ASTROCLAW_BROWSER_PROFILE_NAME = "astroclaw";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "astroclaw";
