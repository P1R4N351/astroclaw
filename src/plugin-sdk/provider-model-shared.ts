...
import { normalizeProviderId as normalizeProviderIdCore } from "@astroclaw/model-catalog-core/provider-id";
import {
...
export { isCloudModelRef } from "@astroclaw/model-catalog-core/model-catalog-refs";
