...
/**
 * @deprecated Compatibility facade for the `astroclaw/plugin-sdk/discord` subpath.
...
export type { AstroclawPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
export type DiscordAccountConfig = NonNullable<NonNullable<AstroclawConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: AstroclawConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: AstroclawConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: AstroclawConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: AstroclawConfig }): AstroclawConfig {
...
export function listDiscordAccountIds(cfg: AstroclawConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: AstroclawConfig): string {
