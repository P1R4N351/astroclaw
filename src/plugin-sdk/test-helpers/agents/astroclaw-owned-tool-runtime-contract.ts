...
export function installAstroclawOwnedToolHooks(params?: {
 ...
 * Pair with `installAstroclawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetAstroclawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
