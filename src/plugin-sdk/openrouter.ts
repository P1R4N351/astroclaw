...
import type { ModelProviderConfig, AstroclawConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: AstroclawConfig) => AstroclawConfig;
  applyOpenrouterProviderConfig: (cfg: AstroclawConfig) => AstroclawConfig;
