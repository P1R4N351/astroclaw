...
import { readSecretFileSync as readSecretFileSyncImpl } from "@astroclaw/fs-safe/secret";
...
} from "@astroclaw/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@astroclaw/fs-safe/secret";
