  ...
  return withEnvAsync(
    {
      ...
      ASTROCLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when ASTROCLAW_VERSION is not set", async () => {
  ...
  it("prefers ASTROCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over ASTROCLAW_SERVICE_VERSION when ASTROCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        ASTROCLAW_VERSION: " ",
        ASTROCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when ASTROCLAW_VERSION and ASTROCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        ASTROCLAW_VERSION: " ",
        ASTROCLAW_SERVICE_VERSION: "\t",
