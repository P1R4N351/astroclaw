...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): AstroclawConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): AstroclawConfig {
  return {
