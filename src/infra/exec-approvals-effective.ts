...
const DEFAULT_HOST_PATH = "~/.astroclaw/exec-approvals.json";
...
function formatRequestedSource(params: {
  ...
  return params.sourcePath === "__default__"
    ? `Astroclaw default (${params.defaultValue})`
...
function formatHostFieldSource(params: {
  ...
  if (params.field === "askFallback") {
    return `Astroclaw default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
  }
