 ...
 *
 * @see https://github.com/astroclaw/astroclaw/issues/31884
 * @see https://github.com/astroclaw/astroclaw/issues/18558
 */
...
const INTERNAL_RUNTIME_DELIMITED_BLOCKS = [
  ["<<<BEGIN_ASTROCLAW_INTERNAL_CONTEXT>>>", "<<<END_ASTROCLAW_INTERNAL_CONTEXT>>>"],
] as const;
