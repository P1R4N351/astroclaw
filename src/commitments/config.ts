...
export function resolveCommitmentsConfig(cfg?: AstroclawConfig): ResolvedCommitmentsConfig {
...
export function resolveCommitmentTimezone(cfg?: AstroclawConfig): string {
