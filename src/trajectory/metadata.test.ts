...
describe("trajectory metadata", () => {
  it("redacts harness argv and local paths with the support redaction rules", () => {
    ...
    process.argv = [
      "node",
      "/Users/tester/project/astroclaw.js",
      "--api-key",
      "super-secret",
      "--config=/Users/tester/.astroclaw/astroclaw.json",
    ];
    try {
      const metadata = buildTrajectoryRunMetadata({
        env: {
          HOME: "/Users/tester",
          ASTROCLAW_STATE_DIR: "/Users/tester/.astroclaw",
        },
      ...
      expect(harness.invocation).toEqual([
        "node",
        "~/project/astroclaw.js",
        "--api-key",
        "<redacted>",
        "--config=$ASTROCLAW_STATE_DIR/astroclaw.json",
      ]);
      expect(harness.entrypoint).toBe("~/project/astroclaw.js");
