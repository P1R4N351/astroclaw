...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    ...
    vi.stubEnv("ASTROCLAW_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses ASTROCLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          ASTROCLAW_GATEWAY_TOKEN: "new-token",
        },
