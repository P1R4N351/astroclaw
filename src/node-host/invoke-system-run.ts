...
type ExecToolConfig = NonNullable<NonNullable<AstroclawConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<AstroclawConfig> {
