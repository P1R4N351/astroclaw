...
export function listChannelMessageActions(cfg: AstroclawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: AstroclawConfig): ChannelMessageCapability[] {
