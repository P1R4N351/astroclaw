...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: AstroclawConfig): string | undefined {
  ...
  function listAccountIds(cfg: AstroclawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AstroclawConfig): string {
