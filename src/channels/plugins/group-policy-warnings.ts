...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: AstroclawConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: AstroclawConfig }>(
  collector: WarningCollector<{ cfg: AstroclawConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: AstroclawConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: AstroclawConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: AstroclawConfig },
>(
  projectCfg: (cfg: AstroclawConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: AstroclawConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: AstroclawConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: AstroclawConfig },
>(params: {
  providerConfigPresent: (cfg: AstroclawConfig) => boolean;
