...
/** @deprecated Use `channelRouteTargetsMatchExact` from `astroclaw/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `astroclaw/plugin-sdk/channel-route`. */
