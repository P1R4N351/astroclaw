...
export type ChannelMessageSendTextContext<TConfig = AstroclawConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = AstroclawConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = AstroclawConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendAttemptContext<TConfig = AstroclawConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = AstroclawConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = AstroclawConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
