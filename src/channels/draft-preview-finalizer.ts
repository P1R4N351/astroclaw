...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `astroclaw/plugin-sdk/channel-message`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `astroclaw/plugin-sdk/channel-message`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `astroclaw/plugin-sdk/channel-message`.
 */
