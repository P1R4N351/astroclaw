...
export const LEGACY_MEMORY_LIGHT_DREAMING_EVENT_TEXT = "__astroclaw_memory_core_light_sleep__";
...
export const LEGACY_MEMORY_REM_DREAMING_EVENT_TEXT = "__astroclaw_memory_core_rem_sleep__";
...
export function resolveMemoryDreamingPluginId(
  cfg: AstroclawConfig | Record<string, unknown> | undefined,
): string {
