...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("astroclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("astroclaw.contextEngineRegistryState");
