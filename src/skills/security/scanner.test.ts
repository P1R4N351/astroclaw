// P10 RELAXATIONS: R8 R10 — the eval/new Function/console.log tokens below are
// FIXTURE STRINGS (template-literal test payloads) this security-scanner test
// exists to detect; nothing in this file executes them.
