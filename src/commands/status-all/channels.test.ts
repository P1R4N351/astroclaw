      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run astroclaw plugins install @astroclaw/feishu or astroclaw doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run astroclaw doctor --fix",
        },
      ],
      details: [],
    });
