...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: AstroclawConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: AstroclawConfig, deps?: BrowserDoctorDeps) {
  try {
