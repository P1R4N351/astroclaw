...
export function scanLegacyToolsBySenderKeys(cfg: AstroclawConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: AstroclawConfig): {
