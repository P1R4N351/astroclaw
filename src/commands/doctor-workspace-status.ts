...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("astroclaw tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("astroclaw tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: AstroclawConfig) {
