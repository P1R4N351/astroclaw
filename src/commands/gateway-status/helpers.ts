...
import type { AstroclawConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: AstroclawConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
export function buildNetworkHints(cfg: AstroclawConfig) {
