...
function resolveConfiguredCommandOwners(cfg: AstroclawConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: AstroclawConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: AstroclawConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("astroclaw config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
