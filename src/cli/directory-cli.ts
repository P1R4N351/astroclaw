    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["astroclaw directory self --channel slack", "Show the connected account identity."],
          [
            'astroclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["astroclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "astroclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.astroclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
