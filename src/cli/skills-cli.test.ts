...
describe("skills-cli", () => {
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("astroclaw skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("astroclaw skills install");
    });
    ...
    it("shows API key storage guidance for the active config path", () => {
      ...
      expect(output).toContain("ASTROCLAW_CONFIG_PATH");
      expect(output).toContain("default: ~/.astroclaw/astroclaw.json");
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("astroclaw skills update");
    });
