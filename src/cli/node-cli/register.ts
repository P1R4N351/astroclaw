    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "astroclaw node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["astroclaw node status", "Check node host service status."],
          ["astroclaw node install", "Install the node host service."],
          ["astroclaw node start", "Start the installed node host service."],
          ["astroclaw node restart", "Restart the installed node host service."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/node", "docs.astroclaw.ai/cli/node")}\n`,
    );
