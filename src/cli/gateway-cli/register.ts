      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["astroclaw gateway run", "Run the gateway in the foreground."],
            ["astroclaw gateway status", "Show service status plus connectivity/capability."],
            ["astroclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["astroclaw gateway stability", "Show recent stability diagnostics."],
            ["astroclaw gateway call health", "Call a gateway RPC method directly."],
