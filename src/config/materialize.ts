...
import type { AstroclawConfig, ResolvedSourceConfig, RuntimeConfig } from "./types.js";
...
export function asResolvedSourceConfig(config: AstroclawConfig): ResolvedSourceConfig {
  return config as ResolvedSourceConfig;
}

export function asRuntimeConfig(config: AstroclawConfig): RuntimeConfig {
