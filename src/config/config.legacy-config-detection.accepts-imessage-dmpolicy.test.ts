...
function expectAstroclawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = AstroclawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectAstroclawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = AstroclawSchema.safeParse(config);
