...
describe("getCachedPluginModuleLoader", () => {
  ...
  it("normalizes Windows absolute paths before creating and calling the source transformer", async () => {
    ...
    const loader = getCachedPluginModuleLoader({
      cache,
      modulePath: "C:\\Users\\alice\\astroclaw\\dist\\extensions\\feishu\\api.js",
      importerUrl: "file:///C:/Users/alice/astroclaw/dist/src/plugins/public-surface-loader.js",
      loaderFilename: "C:\\Users\\alice\\astroclaw\\dist\\extensions\\feishu\\api.js",
      tryNative: true,
      createLoader: asPluginModuleLoaderFactory(createJiti),
    });

    loader("C:\\Users\\alice\\astroclaw\\dist\\extensions\\feishu\\api.js");

    expectJitiOptions(
      createJiti,
      0,
      "file:///C:/Users/alice/astroclaw/dist/extensions/feishu/api.js",
      { tryNative: true },
    );
  ...
  it("skips the native-require fast path when tryNative is explicitly false", async () => {
    ...
    const loader = getCachedPluginModuleLoader({
      ...
      aliasMap: { "astroclaw/plugin-sdk": "/repo/shim.js" },
      tryNative: false,
      createLoader: asPluginModuleLoaderFactory(createJiti),
    });
  ...
  it("normalizes Windows absolute paths when native loading is disabled", async () => {
    ...
    const loader = getCachedPluginModuleLoader({
      cache,
      modulePath: "C:\\Users\\alice\\astroclaw\\extensions\\feishu\\api.ts",
      importerUrl: "file:///C:/Users/alice/astroclaw/src/plugins/loader.ts",
      loaderFilename: "C:\\Users\\alice\\astroclaw\\extensions\\feishu\\api.ts",
      tryNative: false,
      createLoader: asPluginModuleLoaderFactory(createJiti),
    });

    loader("C:\\Users\\alice\\astroclaw\\extensions\\feishu\\api.ts");

    expect(nativeStub).not.toHaveBeenCalled();
    expectJitiOptions(createJiti, 0, "file:///C:/Users/alice/astroclaw/extensions/feishu/api.ts", {
      tryNative: false,
    });
    expect(fromSourceTransformer).toHaveBeenCalledWith(
      "file:///C:/Users/alice/astroclaw/extensions/feishu/api.ts",
    );
  });
