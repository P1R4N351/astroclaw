...
import type { AstroclawPluginCliCommandDescriptor } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("astroclaw.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<AstroclawConfig | null> => {
