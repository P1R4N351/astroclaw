...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "ASTROCLAW_PLUGIN_INSTALL_OVERRIDES";
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "ASTROCLAW_ALLOW_PLUGIN_INSTALL_OVERRIDES";
