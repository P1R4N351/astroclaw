...
const CHANNEL_RUNTIME_SDK_SURFACE = ["astroclaw/plugin-sdk/channel", "runtime"].join("-");
...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    warningStarts: "2026-04-24",
    removeAfter: "2026-07-24",
    replacement: "focused `astroclaw/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["astroclaw/plugin-sdk", "astroclaw/plugin-sdk/compat"],
    diagnostics: ["ASTROCLAW_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    replacement:
      "`astroclaw/plugin-sdk/bundled-channel-config-schema` for maintained bundled plugins; plugin-local schemas for third-party plugins",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["astroclaw/plugin-sdk/channel-config-schema-legacy"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-28",
    replacement:
      "focused `astroclaw/plugin-sdk/*` test subpaths such as `plugin-test-runtime`, `channel-test-helpers`, `test-env`, and `test-fixtures`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["astroclaw/plugin-sdk/testing"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "astroclaw/plugin-sdk/channel-route channelRouteIdentityKey",
      "astroclaw/plugin-sdk/channel-route channelRouteKey",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    surfaces: ["astroclaw.plugin.json providerAuthEnvVars", "provider setup"],
  ...
  },
  {
    ...
    docsPath: "/plugins/manifest",
    surfaces: ["astroclaw.plugin.json channelEnvVars", "channel setup"],
    diagnostics: ["manifest compatibility diagnostic"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`astroclaw/plugin-sdk/agent-runtime`",
    docsPath: "/plugins/sdk-agent-harness",
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`astroclaw plugins registry --refresh` and `astroclaw doctor --fix`",
    docsPath: "/cli/plugins#registry",
    surfaces: ["ASTROCLAW_DISABLE_PERSISTED_PLUGIN_REGISTRY", "plugin registry reads"],
  ...
  },
  {
    ...
    docsPath: "/cli/plugins#registry",
    surfaces: [
      "ASTROCLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION",
      "ASTROCLAW_FORCE_PLUGIN_REGISTRY_MIGRATION",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`astroclaw.channel.exposure` metadata",
    docsPath: "/plugins/sdk-setup",
    surfaces: ["astroclaw.channel.showConfigured", "astroclaw.channel.showInSetup"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "focused channel SDK subpaths, especially `astroclaw/plugin-sdk/channel-runtime-context`",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`astroclaw/plugin-sdk/command-status`",
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "astroclaw/plugin-sdk/command-auth buildCommandsMessage",
      "astroclaw/plugin-sdk/command-auth buildCommandsMessagePaginated",
      "astroclaw/plugin-sdk/command-auth buildHelpMessage",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`AstroclawConfig`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["astroclaw/plugin-sdk `ClawdbotConfig` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    code: "astroclaw-schema-type-alias",
    status: "deprecated",
    owner: "sdk",
    introduced: "2026-04-26",
    deprecated: "2026-04-26",
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`AstroclawConfig` from `astroclaw/plugin-sdk/config-schema`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["astroclaw/plugin-sdk `AstroclawSchemaType` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "injected `api.runtime.*` helpers or focused `astroclaw/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["astroclaw/extension-api"],
    diagnostics: ["ASTROCLAW_EXTENSION_API_DEPRECATED"],
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "astroclaw/plugin-sdk/channel-actions createMessageToolButtonsSchema",
      "astroclaw/plugin-sdk/channel-actions createMessageToolCardSchema",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "astroclaw/plugin-sdk/channel-inbound resolveMentionGating",
      "astroclaw/plugin-sdk/channel-inbound resolveMentionGatingWithBypass",
      "astroclaw/plugin-sdk/channel-mention-gating resolveMentionGating",
      "astroclaw/plugin-sdk/channel-mention-gating resolveMentionGatingWithBypass",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-provider-plugins",
    surfaces: ["astroclaw/plugin-sdk/provider-web-search createPluginBackedWebSearchProvider"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "focused `astroclaw/plugin-sdk/*` test subpaths",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["astroclaw/plugin-sdk/test-utils"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
      "src/plugins/contracts/plugin-sdk-subpaths.test.ts",
