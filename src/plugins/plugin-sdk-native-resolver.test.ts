...
describe("installOpenClawPluginSdkNativeResolver", () => {
  ...
  it("resolves internal core packages only for OpenClaw-owned source parents", () => {
    ...
    expect(installedAliases).toContain("@astroclaw/media-core/attachment-classify");
    ...
    expect(
      fs.realpathSync(requireFromCoreSource.resolve("@astroclaw/media-core/attachment-classify")),
    ...
    expect(
      fs.realpathSync(requireFromCoreSource.resolve("@astroclaw/acp-core/runtime/types")),
    ...
    expect(() => requireFromPlugin.resolve("@astroclaw/media-core/attachment-classify")).toThrow();
