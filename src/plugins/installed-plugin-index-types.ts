...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Astroclaw from plugin manifests, install records, and config policy. Use `astroclaw plugins registry --refresh`, `astroclaw plugins install/update/uninstall`, or `astroclaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored astroclaw.install metadata. This describes catalog/package
