...
const resolveAuthAgentDir = (agentDir?: string, config?: AstroclawConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: AstroclawConfig): SecretRef {
