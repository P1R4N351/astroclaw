...
import type { AstroclawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = AstroclawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("astroclaw.pluginCommandsState");
