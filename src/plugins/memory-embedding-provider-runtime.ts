...
function readConfiguredProviderApiId(providerId: string, cfg?: AstroclawConfig): string | undefined {
...
function resolveMemoryEmbeddingProviderLookupIds(id: string, cfg?: AstroclawConfig): string[] {
  const ids = [id];
