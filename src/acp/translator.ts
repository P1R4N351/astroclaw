...
function buildSessionPresentation(params: {
  ...
  const configOptions: SessionConfigOption[] = [
    buildSelectConfigOption({
      ...
      description:
        "Controls how much deliberate reasoning Astroclaw requests from the Gateway model.",
    ...
    buildSelectConfigOption({
      ...
      name: "Tool verbosity",
      description:
        "Controls how much tool progress and output detail Astroclaw keeps enabled for the session.",
    ...
    buildSelectConfigOption({
      ...
      name: "Usage detail",
      description:
        "Controls how much usage information Astroclaw attaches to responses for the session.",
...
export class AcpGatewayAgent implements Agent {
  ...
  private assertSupportedSessionSetup(mcpServers: ReadonlyArray<unknown>): void {
    ...
    throw new Error(
      "ACP bridge mode does not support per-session MCP servers. Configure MCP on the Astroclaw gateway or agent instead.",
    );
  }
